...
public:
    ...
    QLineEdit *addNameEdit_2;
    QLabel *label;
    QLineEdit *addNameEdit_3;
    ...
    void setupUi(QWidget *ClientWidget)
    {
        ...
        addFormLayout->setWidget(1, QFormLayout::LabelRole, label_2);
        ...
        addFormLayout->setWidget(2, QFormLayout::LabelRole, addServiceNameLabel);

        addNameEdit_2 = new QLineEdit(addTab);
        addNameEdit_2->setObjectName("addNameEdit_2");

        addFormLayout->setWidget(2, QFormLayout::FieldRole, addNameEdit_2);

        label = new QLabel(addTab);
        label->setObjectName("label");

        addFormLayout->setWidget(3, QFormLayout::LabelRole, label);

        addNameEdit_3 = new QLineEdit(addTab);
        addNameEdit_3->setObjectName("addNameEdit_3");

        addFormLayout->setWidget(3, QFormLayout::FieldRole, addNameEdit_3);
...
"", nullptr));
        ...
        label_2->setText(QCoreApplication::translate("ClientWidget", "Name", nullptr));
        addServiceNameLabel->setText(QCoreApplication::translate("ClientWidget", "Email", nullptr));
        label->setText(QCoreApplication::translate("ClientWidget", "Preference", nullptr));
        addServicePriceLabel->setText(QCoreApplication::translate("ClientWidget", "Adresse", nullptr));
