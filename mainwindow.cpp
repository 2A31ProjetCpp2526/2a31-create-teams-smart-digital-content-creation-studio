    ...
    , currentPageIndex(-1)
{
    ...
    connect(loginButton, &QPushButton::clicked, [=]() {
        ...
        // Validate credentials and connect to database
        if (username == "adminInspiraStudio" && password == "alawi") {
            // Try to establish Oracle connection
            QSqlDatabase db = QSqlDatabase::addDatabase("QODBC");
            db.setDatabaseName("InspiraStudio"); // DSN name
            ...
            if (db.open()) {
                ...
                errorLabel->setText("❌ Database connection failed. Please check Oracle service.");
    ...
    if (!connected) {
        ...
        statusMsg = QString("❌ DATABASE CONNECTION FAILED!\n\n"
                           ...
                           "Username: SYSTEM\n\n"
                           "Please check:\n"
                           "1. ODBC DSN 'EmployerDB' exists (64-bit)\n"
