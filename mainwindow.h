...
// Forward declarations for sponsor functionality
class Sponsor;
...
private slots:
    ...
    // Additional features (Todo/Calendar)
...
private:
    ...
    void populateFieldsFromSponsor(const class Sponsor &sponsor);
    class Sponsor getSponsorFromFields();
